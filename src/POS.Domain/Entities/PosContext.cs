...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-GTD6VKV;Database=POS;User Id=sa;Password=jatniel19;TrustServerCertificate=true");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<BranchOffice>(entity =>
        {
            entity.HasKey(e => e.BranchOfficeId).HasName("PK__BranchOf__27247FF96BC2DD4E");
        ...
        {
            entity.HasKey(e => e.BusinessId).HasName("PK__Business__F1EAA36E893A1D5A");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A0B556A8131");
        ...
        {
            entity.HasKey(e => e.ClientId).HasName("PK__Clients__E67E1A24B3C64FC2");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BED06E84021");
        ...
        {
            entity.HasKey(e => e.DistrictId).HasName("PK__District__85FDA4C658D6B5C5");
        ...
        {
            entity.HasKey(e => e.DocumentTypeId).HasName("PK__Document__DBA390E13D562F2C");
        ...
        {
            entity.HasKey(e => e.MenuId).HasName("PK__Menus__C99ED23062880FD5");
        ...
        {
            entity.HasKey(e => e.MenuRolId).HasName("PK__MenuRole__6640AD0C8C60EB3A");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6CD43C23373");
        ...
        {
            entity.HasKey(e => e.ProviderId).HasName("PK__Provider__B54C687DF2FD48B5");
        ...
        {
            entity.HasKey(e => e.ProvinceId).HasName("PK__Province__FD0A6F83D7C697F8");
        ...
        {
            entity.HasKey(e => e.PurcharseId).HasName("PK__Purchars__A98C674BEFEFAA1F");
        ...
        {
            entity.HasKey(e => e.PurcharseDetailId).HasName("PK__Purchars__7353248BCDF3B279");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE1A26C57819");
        ...
        {
            entity.HasKey(e => e.SaleId).HasName("PK__Sales__1EE3C3FF1308C64F");
        ...
        {
            entity.HasKey(e => e.SaleDetailId).HasName("PK__SaleDeta__70DB14FE97AC9D3B");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CC4C268DF0AB");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A35BCA866A5");
        ...
        {
            entity.HasKey(e => e.UserBranchOfficeId).HasName("PK__UsersBra__7D1E804A1413BF7A");
