...
public class CategoryRepository : GenericRepository<Category>, ICategoryRepository
{
    ...
    {
        var category = await _context.Categories!.AsNoTracking().FirstOrDefaultAsync(c => c.CategoryId.Equals(categoryId));
    ...
    {
        var category = await _context.Categories.AsNoTracking().SingleOrDefaultAsync(c => c.CategoryId.Equals(categoryId));
